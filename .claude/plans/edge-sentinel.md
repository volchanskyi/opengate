...
| WS-14b | `edge-sentinel-ws-14b-offline-tsdb-build.md` | graduate the `edge-tsdb` crate to the production **redb** store (compact fixed-point codec, big-block packing, inline anomaly bit; holds min/max/last + 1 s) |
