...
Three hundred and twelve alerts are not something a person on call reads. One
room saying "forty machines, since 02:41" is. So every stored alert is folded
into an **incident** in the same write that stores it
