...
| The compute cap is enforced at the live free-tier entitlement | [`free_tier.tftest.hcl`](../deploy/terraform/modules/oke/tests/free_tier.tftest.hcl) (and the [compute module's](../deploy/terraform/modules/compute/tests/free_tier.tftest.hcl)) assert ≤2 OCPU / ≤12 GB total, matching Oracle's current Always Free A1 entitlement (1,500 OCPU-hrs / 9,000 GB-hrs per month) | A node-count or shape change that exceeds 2 OCPU / 12 GB fails the Terraform test at plan time; growth above the public baseline requires verified tenancy limits recorded in an ADR |
