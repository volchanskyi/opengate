...
container (L2) view in [`docs/architecture/System-Architecture.md`](../architecture/System-Architecture.md). Native
...
the end-to-end session lifecycle in [`docs/architecture/System-Architecture.md`](../architecture/System-Architecture.md).
