...
# The statements the hook runs live in a file of their own, because the staging
# deploy runs the same ones again after its browser suite reset destroys the
# account, and two copies of that SQL drift.
