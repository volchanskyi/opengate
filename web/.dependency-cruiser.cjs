...
module.exports = {
  forbidden: [
    ...
    // -------------------------------------------------------------------------
    {
      name: 'adr-022-no-lib-to-feature',
      severity: 'warn',
      comment:
        "The lib layer (src/lib/**) is a leaf — utilities must not depend on " +
        "feature code. If a feature needs to share a helper, lift it into src/lib/.",
      from: { path: '^src/lib/' },
      to: { path: '^src/features/' },
    },
    {
      name: 'adr-022-no-state-to-feature',
      severity: 'warn',
      comment:
...
// generated: dependency-cruiser@17.4.0 on 2026-05-21T00:04:30.636Z
